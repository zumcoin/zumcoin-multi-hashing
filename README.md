...
#### Master Build Status
[![Build Status](https://travis-ci.org/zumcoin/zumcoin-multi-hashing.svg?branch=master)](https://travis-ci.org/zumcoin/zumcoin-multi-hashing) [![Build status](https://ci.appveyor.com/api/projects/status/github/zumcoin/zumcoin-multi-hashing?branch=master&svg=true)](https://ci.appveyor.com/project/zumcoin/zumcoin-multi-hashing/branch/master)

#### Development Build Status
[![Build Status](https://travis-ci.org/zumcoin/zumcoin-multi-hashing.svg?branch=development)](https://travis-ci.org/zumcoin/zumcoin-multi-hashing) [![Build status](https://ci.appveyor.com/api/projects/status/github/zumcoin/zumcoin-multi-hashing?branch=development&svg=true)](https://ci.appveyor.com/project/zumcoin/zumcoin-multi-hashing/branch/development)

[![NPM](https://nodei.co/npm/zumcoin-multi-hashing.png?downloads=true&stars=true)](https://nodei.co/npm/zumcoin-multi-hashing/)
...
npm install zumcoin-multi-hashing
```

So far this native NodeJS addon can do the following hashing algorithms.

```javascript
var multiHashing = require('zumcoin-multi-hashing')
...
* [ZumCoin](https://github.com/zumcoin) ZumCoin Developers
