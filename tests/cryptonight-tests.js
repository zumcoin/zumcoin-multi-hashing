...
var xmrigcnzumvariant0hash = new Buffer('546c3f1badd7c1232c7a3b88cdb013f7f611b7bd3d1d2463540fccbd12997982', 'hex')
var xmrigcnzumvariant1hash = new Buffer('29e7831780a0ab930e0fe3b965f30e8a44d9b3f9ad2241d67cfbfea3ed62a64e', 'hex')
var xmrigcnzumvariant2hash = new Buffer('fc67dfccb5fc90d7855ae903361eabd76f1e40a22a72ad3ef2d6ad27b5a60ce5', 'hex')

var xmrigcnzumlitevariant0hash = new Buffer('5e1891a15d5d85c09baf4a3bbe33675cfa3f77229c8ad66c01779e590528d6d3', 'hex')
var xmrigcnzumlitevariant1hash = new Buffer('ae7f864a7a2f2b07dcef253581e60a014972b9655a152341cb989164761c180a', 'hex')
var xmrigcnzumlitevariant2hash = new Buffer('b2172ec9466e1aee70ec8572a14c233ee354582bcb93f869d429744de5726a26', 'hex')
...
var cnzumvariant0Data = multiHashing['cryptonight-zum'](xmrigdata, 0)
var cnzumvariant1Data = multiHashing['cryptonight-zum'](xmrigdata, 1)
var cnzumvariant2Data = multiHashing['cryptonight-zum'](xmrigdata, 2)
var cnzumlitevariant0Data = multiHashing['cryptonight-zum-lite'](xmrigdata, 0)
var cnzumlitevariant1Data = multiHashing['cryptonight-zum-lite'](xmrigdata, 1)
var cnzumlitevariant2Data = multiHashing['cryptonight-zum-lite'](xmrigdata, 2)
...
console.log('')
console.log('[#14] Cryptonight Zum v0: ', cnzumvariant0Data.toString('hex'))
assert.deepEqual(cnzumvariant0Data, xmrigcnzumvariant0hash)
console.log('[#15] Cryptonight Zum v1: ', cnzumvariant1Data.toString('hex'))
assert.deepEqual(cnzumvariant1Data, xmrigcnzumvariant1hash)
console.log('[#16] Cryptonight Zum v2: ', cnzumvariant2Data.toString('hex'))
assert.deepEqual(cnzumvariant2Data, xmrigcnzumvariant2hash)
console.log('')
console.log('[#17] Cryptonight Zum Lite v0: ', cnzumlitevariant0Data.toString('hex'))
assert.deepEqual(cnzumlitevariant0Data, xmrigcnzumlitevariant0hash)
console.log('[#18] Cryptonight Zum Lite v1: ', cnzumlitevariant1Data.toString('hex'))
assert.deepEqual(cnzumlitevariant1Data, xmrigcnzumlitevariant1hash)
console.log('[#19] Cryptonight Zum Lite v2: ', cnzumlitevariant2Data.toString('hex'))
assert.deepEqual(cnzumlitevariant2Data, xmrigcnzumlitevariant2hash)
